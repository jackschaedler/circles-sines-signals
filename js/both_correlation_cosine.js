var SIG_CORRELATION_INTERACTIVE_COS = (function() {
...
var vis = d3.select('#sigCorrelationInteractiveCos');
...
var corrSig2 = d3.svg.line()
  .x(function (d, i) { return xRangeCorr(d)})
  .y(function (d, i) { return yRangeCorr1(Math.cos(d * signalFreq)); });

var corrSig3 = d3.svg.line()
  .x(function (d, i) { return xRangeCorr(d)})
  .y(function (d, i) { return yRangeCorr2(inputSignal(d + signalPhase) * Math.cos(d * signalFreq)); });
...
var dpArea = d3.svg.area()
  ...
  .y0(yRangeCorr2(0))
  .y1(function(d) { return yRangeCorr2(inputSignal(d + signalPhase) * Math.cos(d * signalFreq)); });
...
var samples2 = vis.selectAll(".point2")
  ...
  .enter().append("svg:circle")
    ...
    .attr("opacity", 0.7)
    .attr("cx", function(d, i) { return xRangeCorr(d); })
    .attr("cy", function(d, i) { return yRangeCorr1(Math.cos(d * signalFreq + signalPhase)); })
    .attr("r", function(d, i) { return 2.0 });
...
var connectors = vis.selectAll(".connectors")
  ...
  .enter().append("line")
    ...
    .attr("y2", function(d, i) { return yRangeCorr2(inputSignal(d) * Math.cos(d * signalFreq + signalPhase)); })
...
var samples3 = vis.selectAll(".point3")
  ...
  .enter().append("svg:circle")
    ...
    .attr("opacity", 0.7)
    .attr("cx", function(d, i) { return xRangeCorr(d); })
    .attr("cy", function(d, i) { return yRangeCorr2(inputSignal(d) * Math.cos(d * signalFreq + signalPhase)); })
    .attr("r", function(d, i) { return 2.0 });
...
function draw() {
  ...
  samples2.data(corrSigSampleData)
    .attr("cx", function(d, i) { return xRangeCorr(d); })
    .attr("cy", function(d, i) { return yRangeCorr1(Math.cos(d * signalFreq)); });

  samples3.data(corrSigSampleData)
    .attr("cx", function(d, i) { return xRangeCorr(d); })
    .attr("cy", function(d, i) { return yRangeCorr2(inputSignal(d + signalPhase) * Math.cos(d * signalFreq)); });

  connectors.data(corrSigSampleData)
    .attr("x1", function(d, i) { return xRangeCorr(d); })
    .attr("y1", function(d, i) { return yRangeCorr(inputSignal(d)); })
    .attr("x2", function(d, i) { return xRangeCorr(d); })
    .attr("y2", function(d, i) { return yRangeCorr2(inputSignal(d + signalPhase) * Math.cos(d * signalFreq)); });
  ...
  for (i = 0; i < corrSigSampleData.length; i++)
  {
    ...
    dotProduct += inputSignal(d) * Math.cos(d * signalFreq + signalPhase);
  }
